...
static Level level1={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, NULL, ROAD, 2, TRUCK_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_RIGHT},
...
static Level level2={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_LEFT},
        ...
        {NO_CHECKPOINT, NULL, ROAD, 4, TRUCK_LENGTH, MIN_GAP, SLOW, DIR_RIGHT},

        {CHECKPOINT_1, NULL, SAFE, 0, 0, 0, 0, DIR_LEFT},
        {CHECKPOINT_1, NULL, SAFE, 0, 0, 0, 0, DIR_LEFT},

        {NO_CHECKPOINT, NULL, WATER, 3, MEDIUM, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, NULL, WATER, 4, SMALL, MEDIUM_GAP, FAST, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, WATER, 3, LARGE, MAX_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, NULL, WATER, 4, MEDIUM, MAX_GAP, SLOW, DIR_RIGHT},
...
static Level level3={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MAX_GAP, FAST, DIR_LEFT},
        {NO_CHECKPOINT, NULL, ROAD, 2, TRUCK_LENGTH, MAX_GAP, MEDIUM_SPEED, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, ROAD, 3, CAR_LENGTH, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, NULL, ROAD, 4, TRUCK_LENGTH, MIN_GAP, SLOW, DIR_RIGHT},
        ...
        {NO_CHECKPOINT, NULL, WATER, 3, MEDIUM, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, NULL, WATER, 4, SMALL, MAX_GAP, FAST, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, WATER, 2, MEDIUM, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, NULL, WATER, 3, MEDIUM, MEDIUM_GAP, FAST, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, WATER, 1, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
