 ...
 ******************************************************************************/
 ...
 static Level level1={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_LEFT},
        {NO_CHECKPOINT, NULL, ROAD, 2, CAR_LENGTH, MEDIUM_GAP, SLOW, DIR_RIGHT},
        ...
        {NO_CHECKPOINT, NULL, WATER, 2, MEDIUM, MEDIUM_GAP, SLOW, DIR_LEFT},
...
static Level level2={
    ...
    NULL, 
    {
        ...
        {NO_CHECKPOINT, NULL, WATER, 3, SMALL, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, WATER, 3, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
        {NO_CHECKPOINT, NULL, WATER, 3, MEDIUM, MEDIUM_GAP, SLOW, DIR_RIGHT},
        {NO_CHECKPOINT, NULL, WATER, 3, LARGE, MEDIUM_GAP, MEDIUM_SPEED, DIR_LEFT},
